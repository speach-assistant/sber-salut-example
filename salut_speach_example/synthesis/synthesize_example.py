...
def synthesize(args):
    ...
    token_cred = grpc.access_token_call_credentials(os.environ.get('ACCESS_TOKEN'))
...
class Arguments:
    NOT_SYNTHESIS_OPTIONS = {'host', 'file'}
...
def create_parser(encodings=None):
    ...
    parser.add_argument('--voice', default='Bys_24000', help=' ')
